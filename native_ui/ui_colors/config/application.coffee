...
steroids.config.name = "Steroids Academy: Native UI Colors"
...
steroids.config.tabBar.tabTitleColor = "#000000"
steroids.config.tabBar.tabTitleShadowColor = "#FFFFFF"
steroids.config.tabBar.selectedTabTintColor = "#000000"
